...
function addInventory(product, inventoryNumber) {
  product.inventory += inventoryNumber;
  console.log(inventoryNumber + " " + product.name + " added to the inventory");
}

// 3. Call the addInventory() function

addInventory(products, 3);
console.log(products.inventory + " " + products.name + " in stock");
...
function processSale(product, quantitySold) {
  product.inventory -= quantitySold;
  console.log(quantitySold + " " + product.name + " sold");
  return quantitySold * product.unit_price;
}
...
console.log("Total sale: $" + processSale(products, 3));
